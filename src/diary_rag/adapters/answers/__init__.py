...
Adapter selection is driven by ``Settings.chat_backend`` (``mock`` only
in Slice 4.3a; real provider adapters land in a later packet); domain
code remains SDK-free (Invariant I-11).
...
__all__ = ["MockChatClient", "build_chat_client"]
