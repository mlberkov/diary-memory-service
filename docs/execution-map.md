...
| 4.3b fallback modes | weak-evidence, ambiguous, provider-unavailable, parse-failure grading (I-9, R-5, R-6); marker semantics beyond `{confident, uncertain, no_evidence}`; `confidence_band` decision |
