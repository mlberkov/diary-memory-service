...
primitive and Slice 6.2 (D-048) landed the persistent dead-letter surface for
failed indexing jobs. No other `OP-` packet has been executed. This document records the
