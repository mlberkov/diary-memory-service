...
Slice 8.1 hardens community scoping on every read so cross-community leakage is prevented and access behavior is explicit (Phase-8 DoD; I-7 / R-3 / R-8). What it enforces, for the operator:
